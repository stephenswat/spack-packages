...
class Acts(CMakePackage, CudaPackage):
    ...
    version("43.3.0", commit="b39380d3522ec7f535adffcc3461f415b9c59bd2", submodules=submodules)
    version("43.2.0", commit="929ef5cab2ec9447159587299896619c5b5cdabb", submodules=submodules)
    version("43.1.0", commit="9925626464339d95a778222fdbf1546b81887f05", submodules=submodules)
    version("43.0.1", commit="a971927dd192bb327effedaca78aad73c72e9779", submodules=submodules)
    version("43.0.0", commit="8fd1145adc3bba4918f9373cfc4c79fedb462a36", submodules=submodules)
    version("42.1.1", commit="8db4dba5854807cb42f3454aa0f740d49fcd6487", submodules=submodules)
    version("42.1.0", commit="dd18c649f79b62d1e4e87da7ce7e3a87ac8b0eef", submodules=submodules)
    version("42.0.0", commit="17ae4962f40628904a60b9654cbac18c4b8d93f0", submodules=submodules)
    version("41.1.0", commit="b36c4cf202b4017ef11c93079cc514915d9a74d4", submodules=submodules)
    version("41.0.0", commit="ea9c248829c938511108478db8a5e5fb2fdfad4c", submodules=submodules)
    version("40.1.0", commit="7b33e0abbb95d0169341e60d32fc61fdd1555c86", submodules=submodules)
    version("40.0.1", commit="6a776e1b1e08c10c196bdeddc62e1352b90eb9cd", submodules=submodules)
    version("40.0.0", commit="5dfb063708250d27a5c7da891eee0be6152e065b", submodules=submodules)
    version("39.2.1", commit="1ee022bc1b2f14bdb2221906fd0a46cea87e073b", submodules=submodules)
    ...
    depends_on("covfie @0.12.1", when="+traccc @40.1:")
    ...
    depends_on("detray @0.89.0:", when="@40.1: +traccc")
    depends_on("detray @0.98.0:", when="@42: +traccc")
    ...
    depends_on("vecmem@1.14.0:", when="@40.1: +traccc")
